        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <button
              ...
              className="bg-[#F5C451] text-[#0F1433] p-4 rounded-xl hover:bg-[#D4AF37] transition-colors flex items-center space-x-3"
            >
            ...
            <button
              ...
              className="bg-white/10 text-white p-4 rounded-xl hover:bg-white/20 transition-colors border border-[#D4AF37]/50 flex items-center space-x-3"
            >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      <h4 className="font-semibold text-white">{fellowship.name}</h4>
                      <div className={`flex items-center space-x-1 ${getStatusColor(fellowship.status)}`}>
